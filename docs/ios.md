...
| Speed | `CLLocation.speed` outdoors — the data source generates no live speed, and a distance over an elapsed time is an average rather than what the athlete is doing now. Indoors, the sport's own speed series |
